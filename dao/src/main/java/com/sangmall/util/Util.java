...
import org.apache.struts2.ServletActionContext;
  ...
  public class Util
  {
   public static String stackTraceToString(Exception e) {  
    ...
    public static void setResponseErrorCode(int errCode)
    {
      Map map = new HashMap();
      map.put("result", Integer.valueOf(errCode));
      try
      {
        String jsonString = mapper.writeValueAsString(map);
        ServletActionContext.getRequest().setAttribute("data", jsonString);
      }
      catch (Exception e) {}
    }
    
    public static Properties fonebizProp = new Properties();
    public static String server_url = null;
    public static String static_res_url = null;
    public static String sip_server_ip = null;
    ...
    static
    {
      ...
      URL url = classLoader.getResource("fonebiz.properties");
      try
      {
        fonebizProp.load(url.openStream());
        server_url = fonebizProp.getProperty("server_url").trim();
        static_res_url = fonebizProp.getProperty("static_res_url").trim();
        sip_server_ip = fonebizProp.getProperty("sip_server_ip").trim();
        env = fonebizProp.getProperty("env");
        if(env != null) env = env.trim();
      }
      catch (IOException e)
      {
        System.out.println("------load fonebiz.properties error ---------");
      }
    ...
    public static void setResponseSuccessResult(Map result)
    {
      if (result == null) {
        result = new HashMap();
      }
    ...
    public static String mapToJson(Map result)
    {
      try
      {
        String jsonString = mapper.writeValueAsString(result);
    ...
    public static String getNameOfBank(char[] charBin, int offset)
    {
      long longBin = 0L;
      for (int i = 0; i < 6; i++) {
        longBin = longBin * 10L + (charBin[(i + offset)] - '0');
      }
